...
export interface IResolutionsClientV1 {
    ...
    getResolutionById(correlationId: string, resolution_id: string, callback: (err: any, resolution: ResolutionV1) => void): void;
    ...
    deleteResolutionById(correlationId: string, resolution_id: string, callback: (err: any, resolution: ResolutionV1) => void): void;
